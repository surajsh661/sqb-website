...
export const SQB_LOGOS: ClientLogo[] = [
  ...
  { name: 'Dashtoon',           src: '/clients/dashtoon.png',  size: 1.10, tone: 'mono' },
  { name: 'Indiefolio',         src: '/clients/indiefolio.png',size: 1.10 },
  { name: 'Industree',          src: '/clients/industree.png', size: 1.10 },
  { name: 'LAPCA',              src: '/clients/lapca.png',     size: 1.33 },
  { name: 'ViralO',             src: '/clients/viralo.png',    size: 1.10, tone: 'mono' },
