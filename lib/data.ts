...
export const SQB_LOGOS: ClientLogo[] = [
  { name: 'Muthoot Finance',    src: '/clients/muthoot.png',   size: 1.00 },
  ...
  { name: 'Dashtoon',           src: '/clients/dashtoon.png',  size: 0.95 },
  { name: 'Indiefolio',         src: '/clients/indiefolio.png',size: 0.95 },
  { name: 'Industree',          src: '/clients/industree.png', size: 0.95 },
  { name: 'LAPCA',              src: '/clients/lapca.png',     size: 0.90 },
  { name: 'ViralO',             src: '/clients/viralo.png',    size: 0.90 },
