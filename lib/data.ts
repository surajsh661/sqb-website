...
export const SQB_LOGOS: ClientLogo[] = [
  ...
  { name: 'GeeksforGeeks',      src: '/clients/gfg.png',       size: 1.54 },
  { name: 'Unacademy',          src: '/clients/unacademy.png', size: 1.60 },
  ...
  { name: 'LAPCA',              src: '/clients/lapca.png',     size: 1.21 },
  { name: 'ViralO',             src: '/clients/viralo.png',    size: 1.10, tone: 'original' },
